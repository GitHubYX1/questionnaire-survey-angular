...
import type { surveyAnswerType, answerType, analysisType, analysisOptionType, fillType, questionType } from "app/types/index";
...
const storeData = new SurveyService();
...
export async function processAnswerData(
  ...
  condition: string,
  screenAnswer: answerType[]
): Promise<{ answer: surveyAnswerType[]; excleList: string[][]; questionList: string[][] }> {
